...
type envConfig struct {
	...
	// $HOME/.nifcloud/credentials on Linux/Unix based systems, and
	...
	// $HOME/.nifcloud/config on Linux/Unix based systems, and
	...
	//
	// Setting a custom HTTPClient in the nifcloud.Config options will override this setting.
